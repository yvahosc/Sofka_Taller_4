 ...
 * ]
 *
 * @version ["VS" 1.0.0,2022-04-30
 *
 * 1.0.0,2022-04-30, La clase corresponde a la versión 1.0.0 del sistema,
    ...
    public static void main(String[] args) {
        ...
        while (flag){
            System.out.println("Ingrese la cantidad de numeros que quiere "
                    + "agregar a la lista o cero para salir de la aplicación.");
